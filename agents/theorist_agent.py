...
class TheoristAgent:
    ...
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "8. TOPOLOGY & INVARIANTS: Compute Berry Curvature and Chern Numbers directly from Hamiltonians.\n"
            "9. TRANSPORT THEORY: Derive Kubo formula integrands for electrical (Drude, Anomalous Hall) and thermal conductivity tensors.\n"
            "10. UNIT ENGINEERING: Enforce retention of physical constants (`hbar`, `k_B`, `e`, `m_e`) in derivations. Ensure dimensional consistency.\n"
            "CRITICAL RULES:\n"
